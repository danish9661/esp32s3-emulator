...
"usb_device|USB_HOST_ENUM=1|USB DEVICE STACK UP;USB DEVICE RESET ENUMSPD;USB DEVICE POLL RDV;USB DEVICE ENUM OK;USB DEVICE PASS;USB DEVICE DONE|60000000"
