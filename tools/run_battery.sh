...
"wifi_ap|WIFI_AP_FIXTURE=1|WIFI AP softAP 1;WIFI AP IP 192.168.4.1;WIFI AP stations 0;WIFI AP clients 0;WIFI AP DONE|60000000"
"espnow|WIFI_ESPNOW_LOOPBACK=1|WIFI ESPNOW init 1;WIFI ESPNOW addpeer 1;WIFI ESPNOW sent 1;WIFI ESPNOW sendcb 1;WIFI ESPNOW rxcb 1;WIFI ESPNOW rx0 A5;WIFI ESPNOW DONE|60000000"
...
"wifi_ap_inwasm|NODE:tools/wifi_harness.mjs|WIFI AP HARNESS PASS||esp32s3_wifi_ap/esp32s3_wifi_ap.merged.bin"
"espnow_inwasm|NODE:tools/wifi_harness.mjs|WIFI ESPNOW HARNESS PASS||esp32s3_espnow/esp32s3_espnow.merged.bin"
